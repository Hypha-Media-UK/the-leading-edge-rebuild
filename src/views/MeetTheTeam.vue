...
const teamMembers = [
  ...
  },
  {
    ...
    bio: 'With over 15 years in the industry, Emma founded The Leading Edge with a vision to create a salon that combines luxury with exceptional skill. Her expertise in hair color transformations and cutting-edge styling techniques has earned her numerous industry awards.',
  ...
  },
  {
    ...
    name: 'James Wilson',
    role: 'Senior Stylist',
    bio: 'James brings a wealth of international experience to our team, having trained in Paris, New York, and London. His innovative approach to hair styling and dedication to understanding each client\'s unique needs has made him a favorite among our regulars.',
  ...
  },
  {
    ...
    bio: 'Zoe is our senior beauty therapist with extensive training in skincare and holistic treatments. Her nurturing approach and technical expertise ensure that every client leaves feeling relaxed and rejuvenated.',
  ...
  },
  {
    ...
    bio: 'Nathan\'s artistic background is evident in his detailed nail art and precise technique. His passion for nail health and beautiful designs has earned him a loyal client base and recognition in the industry.',
  ...
  },
  {
    ...
    bio: 'Olivia specializes in advanced aesthetic treatments, combining cutting-edge technology with traditional techniques. Her extensive knowledge of skin biology and aging processes allows her to create customized treatment plans for each client.',
  ...
  },
  {
    ...
    bio: 'Michael is our expert massage therapist with training in multiple modalities. His holistic approach to wellness focuses on both physical and mental relaxation, creating a truly transformative experience for our clients.',
  ...
  },
  {
    ...
    name: 'Isabella Moore',
    role: 'Junior Stylist',
    bio: 'Isabella is our talented junior stylist who brings fresh creativity and enthusiasm to the team. Having completed her advanced training under Emma\'s guidance, she combines technical precision with an intuitive understanding of current trends.',
